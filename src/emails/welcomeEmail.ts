        ...
        <tr>
            <td style="padding: 20px;">
                <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="center"> <a href="${process.env.NODE_ENV === 'PRODUCTION' ? process.env.PRODUCTION_URL : process.env.DEVELOPMENT_URL}/resources?resourcesButtonEmailClick=true" style="
